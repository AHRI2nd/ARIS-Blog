...
기존 주소인 `AHRI2nd.github.io`로 접속 시 자동으로 리다이렉트되도록 설정해두었으나, 현재 해당 리다이렉트가 비활성화되었습니다.

7월 중으로 복구 예정입니다.

새 주소로 직접 접속해주세요.

**[ahri2nd.xyz](https://ahri2nd.xyz)**


> [!WARNING]
> 기존에 저장된 북마크 혹은 캐시 데이터가 있을경우 페이지 표시에 오류가 생길 수 있습니다.
